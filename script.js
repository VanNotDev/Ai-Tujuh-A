...
async function sendCurrentText() {
  ...
  try {
    ...
    let errorMsg = "Gagal mendapatkan jawaban dari 7A.AI karena masalah database. Silahkan hubungi developer. ";
    
    if (navigator.userAgent.includes('Telegram')) {
      errorMsg += "Gagal mendapatkan jawaban dari 7A.AI karena koneksi anda terputus. Silahkan berikan perintah ulang. ";
    } else {
      errorMsg += "Gagal mendapatkan jawaban dari 7A.AI karena masalah endpoint api. Silahkan hubungi developer. ";
    }
...
$("telegramBtn").addEventListener("click", () => window.open("https://t.me/VannRajinBelajar", "_blank", "noopener,noreferrer"));
